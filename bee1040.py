...
(aprovado ou reprovado após ter pego exame) apresente na última linha uma mensagem "Media final: 
...
'''
nota_N1, nota_N2, nota_N3, nota_N4 = map(float, input().split())

media = ((nota_N1 * 2) + (nota_N2 * 3) + (nota_N3 * 4) + (nota_N4 * 1)) / 10
